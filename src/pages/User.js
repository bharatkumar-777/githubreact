  ...
  return (
    <>
      <div className="w-full mx-auto lg:w-10/12">
        ...
        <div className="grid grid-cold-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3 mb-8 gap-8">
          ...
          <div className="cols-span-2">
            ...
            <div className="w-full rounded-xl shadow-md bg-base-100 stats overflow-hidden">
              {location && (
                <div className="stat">
        ...
        <div className="w-full py-5 mb-6 rounded-lg shadow-md bg-base-100 stats">
              <div className="stat">
                  ...
                  <div className="stat-value pr-5 text-3xl md:text-5xl">{followers}</div>
              </div>
              <div className="stat">
                  <div className="stat-figure text-secondary">
                  ...
                  <div className="stat-value pr-5 text-3xl md:text-5xl">{following}</div>
              </div>
              <div className="stat">
                  <div className="stat-figure text-secondary">
                      <FaUserFriends className="text-3xl md:text-5xl"/>
